...
class __TwigTemplate_b362c94e96bf5969103bed94265d2497b5f8fe0abe11dd538ba6a4819c7b2f6c extends \Twig\Template
{
...
\t\t";
        ...
        // line 54
        echo "\t\t";
        if (twig_length_filter($this->env, $this->getAttribute(($context["loops"] ?? null), "contact", []))) {
            // line 55
...
\t\t\t\t\t\t\t";
            // line 62
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["loops"] ?? null), "contact", []));
...
\t\t";
        ...
        // line 88
        echo "\t\t";
        if ($this->getAttribute(($context["definition"] ?? null), "SHOW_PM_POST_BUTTONS", [])) {
            // line 89
...
\t\t\t\t";
            // line 139
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["loops"] ?? null), "attachment", []));
