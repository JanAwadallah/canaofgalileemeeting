...
class __TwigTemplate_b4e451a0915c8c5ab6d649efae48bd983f178a8e024edf1b8135c66983eb65d6 extends \Twig\Template
{
...
\t\t";
                // line 25
                if ((twig_length_filter($this->env, $this->getAttribute(($context["loops"] ?? null), "to_recipient", [])) || twig_length_filter($this->env, $this->getAttribute(($context["loops"] ?? null), "bcc_recipient", [])))) {
                    echo "<hr />";
                }
                // line 26
                echo "\t\t<div class=\"column1\">
\t\t\t";
                // line 27
                if (twig_length_filter($this->env, $this->getAttribute(($context["loops"] ?? null), "to_recipient", []))) {
                    // line 28
                    echo "\t\t\t\t<dl>
\t\t\t\t\t<dt><label>";
                    // line 29
...
\t\t\t\t\t\t";
                    ...
                    $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["loops"] ?? null), "to_recipient", []));
...
\t\t\t";
                // line 43
                if (twig_length_filter($this->env, $this->getAttribute(($context["loops"] ?? null), "bcc_recipient", []))) {
                    // line 44
                    echo "\t\t\t<div class=\"column2\">
\t\t\t\t<dl>
\t\t\t\t\t<dt><label>";
...
\t\t\t\t\t\t";
                    // line 49
                    $context['_parent'] = $context;
                    $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["loops"] ?? null), "bcc_recipient", []));
