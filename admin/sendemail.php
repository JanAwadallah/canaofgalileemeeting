			...
			<div class="table-responsive">
				...
				foreach($result as $row)
				{
					...
					<tr>
						...
						<td>'.$row["email"].'</td>
						<td>'.$row["AcceptedChoice"].'</td>
						<td>
							<input type="checkbox" name="single_select" class="single_select" data-email="'.$row["email"].'" data-name="'.$row["HusbandName"].'" data-room="'.$row["AcceptedChoice"].'" />
						</td>
						<td>
						<button type="button" name="email_button" class="btn btn-info btn-xs email_button" id="'.$count.'" data-email="'.$row["email"].'" data-name="'.$row["HusbandName"].'"  data-room="'.$row["AcceptedChoice"].'" data-action="single">Send Single</button>
						</td>
					</tr>
					';
				}
